...
void UGrippableCapsuleComponent::OnGrip_Implementation(UGripMotionControllerComponent * GrippingController, const FBPActorGripInformation & GripInformation, bool bWasSocketed) {}
...
void UGrippableCapsuleComponent::OnChildGrip_Implementation(UGripMotionControllerComponent * GrippingController, const FBPActorGripInformation & GripInformation, bool bWasSocketed) {}
...
bool UGrippableCapsuleComponent::RequestsSocketing_Implementation(USceneComponent *& ParentToSocketTo, FTransform_NetQuantize & RelativeTransform, bool & bRetainOwner) { return false; }
...
void UGrippableCapsuleComponent::IsSocketed_Implementation(bool & bIsSocketed)
{
	bIsSocketed = VRGripInterfaceSettings.bIsSocketed;
}

void UGrippableCapsuleComponent::SetIsSocketed_Implementation(bool bIsIsSocketed)
{
