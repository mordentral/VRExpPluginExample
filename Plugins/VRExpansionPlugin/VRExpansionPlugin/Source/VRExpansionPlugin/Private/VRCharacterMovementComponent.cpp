...
{
	((AVRCharacter*)CharacterOwner)->ServerMoveVR(float TimeStamp, InAccel, ClientLoc, CapsuleLoc, ConditionalReps, LFDiff, CapsuleYaw, CompressedMoveFlags, MoveReps, ClientMovementMode);
}
